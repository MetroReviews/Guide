            ...
            <Grid>
              <Cell cols={8} colsL={10} colsM={8}>
                ...
                <p style={{ marginBottom: 0 }}>
                  ...
                  processes and wanted to provide all bot lists and bot list owners with a simple,
                  reliable and user friendly solution that can be merged and added to any framework
                  or language with ease. We did our research and came to the conclusion that this
                  can best be achieved through a dedicated RESTful API that provides its user with a
                  variety of endpoints and querying options.
                </p>
              </Cell>
            </Grid>
          </Margin>
