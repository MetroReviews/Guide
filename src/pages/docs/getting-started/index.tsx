...
const GettingStartedDoc = () => {
  return (
    <Fragment>
      ...
      <p>
        Welcome to the official Metro Reviews Guide/Documentation Site.
      </p>
      <p>
        This site contains basic documentation on the Metro Reviews project As well as its companion Website & API, including information on features and tutorials on common use cases.
      </p>
      <Margin bottom="xs">
        <Heading
          id="about"
        ...
        <p>
          Metro Reviews uses a RESTful API based on a few key Frameworks and Library's such as Python and FastAPI.
          these resources allow us to provide our users with a reliable, customizable, well documented and easy to use
          service. 
        </p>
      </Margin>
      <Margin>
        ...
        <p>
         ...
         {" "}<Hyperlink
          ...
          Once approved they will be provided with a List Key which is used to
          access and "unlock" a variety of our available endpoints. 
        </p>
      </Margin>
      <Margin>
        <Heading
        ...
        <p>
          If you need any assistance using our setting up our API please feel free to reach out to us in our
          {" "}<Hyperlink
